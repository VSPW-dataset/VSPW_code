...
num_class=124
data_dir='/home/miaojiaxu/jiaxu_2/semantic_seg/LVSP_plus_data_label124_480p/data'
#tar_dir ='/home/miaojiaxu/jiaxu_2/semantic_seg/newsaveimages'
tar_dir ='/home/miaojiaxu/jiaxu_2/semantic_seg/newsaveimages_ab/ab'
...
#split='val.txt'
    with open('/home/miaojiaxu/jiaxu_2/semantic_seg/LVSP_plus_data_label124_480p/'+split,'r') as f:
        list_ = f.readlines()
    ...
    for fold in os.listdir(tar_dir):
        ...
        if os.path.isdir(os.path.join(tar_dir,fold)):
            ...
            result_dir=os.path.join(tar_dir,fold)
        else:
            continue
